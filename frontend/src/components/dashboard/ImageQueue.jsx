                      ...
                      >
                          ...
                          {item.type === "gift" ? (
                                ...
                                <img
                                  ...
                                  onError={(e) => {
                                    ...
                                    e.target.parentElement.innerHTML =
                                      '<div style="display:flex;flex-direction:column;align-items:center;gap:12px;color:#f59e0b"><div style="font-size:64px">🎁</div><span style="font-size:14px;font-weight:600">ของขวัญ</span></div>';
                                  }}
                                />
                              ) : (
                            ...
                            <img
                              ...
                              onError={(e) => {
                                e.target.style.display = "none";
                                e.target.parentElement.innerHTML =
                                  '<div style="display:flex;flex-direction:column;align-items:center;gap:8px;color:#94a3b8"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg><span style="font-size:13px">ไม่มีรูปภาพ</span></div>';
                              }}
                            />
                          ) : (
                        ...
                        <div style={{ padding: "16px" }}>
                          ...
                          {item.content && (
                            ...
                            >
                              <div style={{ fontSize: "11px", color: "#64748b", marginBottom: "4px" }}>ข้อความ</div>
                              <div style={{ fontSize: "13px", color: "#334155", lineHeight: "1.5" }}>{item.content}</div>
                            </div>
                          )}
                          ...
                          {item.metadata?.social?.type && item.metadata?.social?.name && (
                            ...
                            >
                              <div style={{ fontSize: "11px", color: "#0369a1", fontWeight: "600" }}>Social:</div>
